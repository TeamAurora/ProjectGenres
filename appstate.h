...
enum GAMESTATE {INTRO, MENU, GAME, LEVEL_SELECT, SCORE_SCREEN, LEVEL_ONE, LEVEL2, LEVEL_THREE}; // possible gamestates (globally scoped so that the application class and every state can utilize the type)
